    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800">
      ...
      <header className="flex justify-between items-center px-8 py-4 bg-gray-900/80 backdrop-blur-sm fixed w-full z-50">
        ...
        <div className="flex gap-4">
          <Link to="/login" className="px-5 py-2 text-cyan-400 hover:text-cyan-300 transition font-medium">
            Entrar
          </Link>
          <Link 
            to="/login" 
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-6 text-gray-400">
              <Link to="#" className="hover:text-cyan-400 transition">Termos de Uso</Link>
              <Link to="#" className="hover:text-cyan-400 transition">Privacidade</Link>
              <Link to="#" className="hover:text-cyan-400 transition">Contato</Link>
            </div>
